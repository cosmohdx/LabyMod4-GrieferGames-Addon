...
public final class LegacyItemGlint {
  ...
  private static void cube() {
    net.minecraft.client.renderer.BufferBuilder renderer = Tessellator.getInstance().getBuffer();
  ...
  private static void face(net.minecraft.client.renderer.BufferBuilder renderer, double x1, double y1, double z1, double x2, double y2, double z2, double x3, double y3, double z3, double x4, double y4, double z4) {
