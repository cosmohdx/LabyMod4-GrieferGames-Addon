package de.cosmohdx.griefergames.v1_19_4;
...
public class VersionedGrieferGamesController extends GrieferGamesController {
  ...
  public int[] filledMapPixels(int mapId) {
    ...
    return de.cosmohdx.griefergames.feature.itempreview.MapPixels.toArgb(data.colors, packed -> net.minecraft.world.level.material.MaterialColor.getColorFromPackedId(packed));
  }
